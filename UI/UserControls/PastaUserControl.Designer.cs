...
{
    partial class PastaUserControl
    {
        /// <summary> 
        ...
        private void InitializeComponent()
        {
            ...
            checkBoxVegetables = new CheckBox();
            checkBoxCheese = new CheckBox();
            checkBoxTomatoSauce = new CheckBox();
            checkBoxMushrooms = new CheckBox();
            checkBoxOlives = new CheckBox();
            ...
            Controls.Add(checkBoxVegetables);
            Controls.Add(checkBoxCheese);
            Controls.Add(checkBoxTomatoSauce);
        ...
        private CheckBox checkBoxVegetables;
        private CheckBox checkBoxCheese;
        private CheckBox checkBoxTomatoSauce;
        private CheckBox checkBoxMushrooms;
        private CheckBox checkBoxOlives;
